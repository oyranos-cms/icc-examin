...
#ifndef my_file_chooser_h
#define my_file_chooser_h
#include <FL/Fl.H>
...
class FL_EXPORT MyFl_File_Chooser {
public:
  enum { SINGLE = 0, MULTI = 1, CREATE = 2, DIRECTORY = 4 }; 
private:
  static Fl_Preferences prefs_; 
  void (*callback_)(MyFl_File_Chooser*, void *data, int finish); 
  void *data_; 
  ...
  void fileNameCB(); 
  void newdir(); 
  static void previewCB(MyFl_File_Chooser *fc); 
  void showChoiceCB(); 
  void update_favorites(); 
  void update_preview(); 
public:
  MyFl_File_Chooser(const char *d, const char *p, int t, const char *title);
  icc_examin_ns::MyFl_Double_Window *window;
private:
  void cb_window_i(icc_examin_ns::MyFl_Double_Window*, void*);
  static void cb_window(icc_examin_ns::MyFl_Double_Window*, void*);
...
public:
  ~MyFl_File_Chooser();
  void callback(void (*cb)(MyFl_File_Chooser *, void *, int), void *d = 0);
