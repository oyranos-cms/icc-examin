...
* [core]:Â compensate for high DPI displaying
...
* und: Darstellung des Profilkopfeintrages nur für ICC Typen
...
* fix: Ansicht synchronisiert mit veränderter Profilkonstellation

2006-03-06
* neu: Monitor Gamma wird kontinuierlich beobachtet

2005-12-20
* neu: Beleuchtung für Farbkörper ein

2005-12-19
* neu: Oberflächennormale berechnen

2005-12-14
* und: osX dock unterstützt, Standardprofilbetrachter
...
* und: Mandrake Test überstanden

2005-10-21
* und: (v0.38-2) angekuendigt
* und: TagTexts bleiben auf Ihrer Höhe stehen auch bei Neuladen des Inhaltes
...
2005-10-13
* fix: ncl2 erste Farbe nicht übertragen in ICCexamin::farbenLese
* fix: Laden/Benachrichtigen verbessert:
* und: set für Warteschleife der zu erneuernden Dateien in ICCexamin::erneuern_
...
* und: Test auf Namen für Profilladen in ICCkette::einfuegen -> Pause
...
2005-09-14
* fix: kein direkter Fl Zeichenaufruf in nicht Nebensträngen
...
2005-09-07
* fix: sprintf durch memcpy ersetzt für URLs; sprintf kann keine %20 Zeichen

2005-09-06
* und: Anpassen an Oyranos-0.1.2
* fix: statisches und dynamisches Verknüpfen mit Elektra
* und: Export einiger icc_oyranos Funktionen nach Oyranos
* fix: filtern von %20 in URLs

2005-09-01
* fix: more cout << (char*) 0; in icc_oyranos.cpp
* fix: Darstellen einer Messtabelle mit null Länge ; noch einen

2005-08-31
* und: www Seite
* und: v0.37
* fix: cout << (char*) 0; in icc_oyranos.cpp
* fix: Darstellen einer Messtabelle mit null Länge
...
2005-08-28
* fix: Gamut Warnung wählbar auch für Messungen TODO: update
* neu: X icon
* neu: punktgroesse für zu viel ncl2 Farben auf 2 voreingestellt

2005-08-27
* fix: nicht verstecktes mft_gl ??bug ein zweites mal verstecken
* fix: neuzeichnen zu zeitiges waehleTag
* und: Menüorganisation
* und: FL_COMMAND+o ist in icc_examin.cpp tastatur() definiert

2005-08-26
* und: neue mutex_trylock nur für fremde Zweige
* neu: Zeit Funktionen
* fix: OpenGLglätten besser steuern
* und: Darstellungsoptionen auffrischen und neue Fenstergröße
* fix: nur aktive Netze werden benamt OpenGL
* fix: Löschen alter Hüllen
* fix: 0 Farben ncl2 Profilabsturz

2005-08-25
* und: OpenGL wieder im Hauptzweig
* neu: Fl::wait(pause/0) sorgen für eine flüssige Oberfläche
...
2005-08-23
* neu: mutexe für das Entlaussystem (icc_utils)
* neu: OpenGL threads

2005-08-20
* neu: Start esperanto in po/eo.po
* neu: eigenständiges "bundle" Ziel in makefile
...
2005-08-13
* fix: farbraummodus (ncl2) wieder aktiviert für CinePaint
* neu: mime für Dateimanager - icc.xml
...
* fix: Löschen alter Hüllumrisse und Namen in ICCgl
...
* und: -fnoexeptions + keine Optimierung während des Übersetzens : schneller
...
2005-08-06
* neu: osX Fl_Sys_Menu wieder entfernt, da nicht kompatibel zu fltk Menüs:
	   Textkodierungsprobleme, kein hide(), kein toogle in Menüleiste,
	   kein update
...
* und: Version 0.36
* und: Speicher kopiert und übernimmt lediglich mit new reservierte Bereiche
...
2005-07-21
* neu: osX Display Profil erkennen und auslesen + vcgt aus Gerät auslesen
...
2005-06-04
* und: Farbhüllwarnung für Messfarben immer, für Lab Auswahl im oberen Menü

2005-06-03
* und: farbiger Balken von gewählten 3D Punkt Lab -> 0ab
...
* fix: Endianes für Solaris korrigiert
* fix: setenv unter Solaris nicht verfügbar
...
* und: neuzeichnen für farbraumModus
...
2005-04-28
* und: Layout im Tagwähler nach links gerückt
* fix: Profile bleiben gewählt wie im Profilewähler eingestellt
* fix: Namen werden im GL Fenster so dargestellt wie im Profilewähler
* neu: Schatten für Einzelfarben hinzugefügt

2005-04-27
* und: de Übersetzung vollständig
...
2005-04-26
* und: Menüs Texte werden ausgetauscht; Fluid Zeigernamen bleiben erhalten
...
2005-04-22
* neu: gettext Übersetzung in fluid und makefile

2005-04-18
* neu: Fonts mit FTGL: nicht innerhalb anderer glLists benutzen
* neu:                 Raster Position mit glRasterPos* setzen
* fix: Farbeinstellungen im 3D Ansichtwähler bleiben erhalten
* fix: setzMesswerte nicht falls keine vorhanden sind
* fix: alte Messwerte mit Laden eines neuen Profiles löschen
...
2005-02-28
* neu: ICCexamin::frei() zur Anzeige der Benutzung eingeführt (pthread)

2005-02-26
* neu: wächter mit pthread eingeführt in ICCkette, überwacht Dateiveränderng
* neu: Modell Beobachter als Rückmeldesystem eingeführt icc_modell_bobachter
* neu: holeDateiModifikationsZeit in icc_helfer
* neu: ICCprofile::changing() zur Anzeige der Benutzung eingeführt

2005-02-24
* neu: viel an der 3D Darstellung gearbeitet
* neu: Umgebungsvariable LANG wird zum Auslesen von mluc Tags verwendet
* fix: Profilenamen werden alle angezeigt; kein glLoadIdentity() für Text
* neu: icc_profile.h viele Funktionen in cpp Dateien verschoben
* neu: ncl2 läuft als Text

2005-02-11
* fix: Beschnitt der Achsenbeschriftung aufgehoben für CIExy
...
2005-01-21
* und: XYZ Messdaten ohne Gerätefarben werden beim Laden als Stern gezeigt
* neu: suchenErsetzen in icc_helfer.h/cpp
* neu: CGATS Daten über icc_examin exportiert
...
* neu: [Escape] wird in icc_examin als Tastenkürzel abgefangen

2005-01-19
* neu: Menüs neu sortiert
* neu: Pfeile/Texte an und aus
* neu: Farbvariablen für Text und Pfeile
...
2005-01-13
* neu: drawCurve/CIE greift über id von TagDrawing auf Daten in icc_examin
...
* fix: leerer string löst Ausnahme bei Zugriff aus in icc_gl.h - DBG Macros!

2005-01-09/10
* fix: doppelter Aufruf von auswahlCb - in MftChoice::profilTag
* und: Textausgabe in GL_Ansicht überarbeitet
* und: glut Menüs neu sortiert
...
2004-12-31
* und: Gedanken über Farbraumhülle
*    : maximaler Farbauftrag für maximale Farbsättigung
*    : Raster (polar oder orthogonal) mit Prüfung des relativen Intents
	auf Veränderung; Begin der Veränderung zeigt das Innere des 
	Farbraumes an
     : Grenze Abtasten bei Verdacht

2004-12-30
* und: OpenGL Tests;  Transparenz - scheint standpunktabhängig
...
* und: Öffnen nach icc_examin verschoben
...
2004-12-14
* fix: mft GL Untermenü: Kanalnamen mit jedem Tagwechsel aktualisiert
* neu: Fl::run aus main entfernt, Oberfläche nun in icc_betrachter
* neu: Klasse icc_examin als zentrales Model begonnen
* neu: neue Farben der Oberfläche, Einheitlich zu osX

2004-12-6
* neu: CLUT Koordinaten besser positioniert 
* fix: CLUT A2B nicht mehr dargestellt
* neu: CLUT B2A alle Kanäle wählbar
* und: bessere Beschriftung namenloser Farbkanäle
* und: RGB und CMYK Messdaten gemeinsam berechnet
* neu: Graudarstellung begonnen, noch fehlerhaft
* neu: Funktionen für Farbkanalanzahl und Test ob CLUT vorhanden
* und: Optimierung für die Entwicklung ausgeschaltet
* und: nicht benötigte Bibliotheken aus make entfernt 

2004-12-5
* bug: Weisspunkt für RGB Messdaten berücksichtigt
* bug: Dunkelablgleich für RGB Messdaten
...
* neu: Menüs neu ordnen

2004/11/24
* neu: binär/ascii Darstellung unbekannter Inhalte
