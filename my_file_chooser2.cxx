...
//
// More MyFl_File_Chooser routines.
//
...
// Contents:
//
//   MyFl_File_Chooser::count()             - Return the number of selected files.
//   MyFl_File_Chooser::directory()         - Set the directory in the file chooser.
//   MyFl_File_Chooser::filter()            - Set the filter(s) for the chooser.
//   MyFl_File_Chooser::newdir()            - Make a new directory.
//   MyFl_File_Chooser::value()             - Return a selected filename.
//   MyFl_File_Chooser::rescan()            - Rescan the current directory.
//   MyFl_File_Chooser::favoritesButtonCB() - Handle favorites selections.
//   MyFl_File_Chooser::fileListCB()        - Handle clicks (and double-clicks)
//                                          in the Fl_File_Browser.
//   MyFl_File_Chooser::fileNameCB()        - Handle text entry in the FileBrowser.
//   MyFl_File_Chooser::showChoiceCB()      - Handle show selections.
...
Fl_Preferences	MyFl_File_Chooser::prefs_(Fl_Preferences::USER, "fltk.org", "filechooser");

const char	*MyFl_File_Chooser::add_favorites_label = "Add to Favorites";
const char	*MyFl_File_Chooser::all_files_label = "All Files (*)";
const char	*MyFl_File_Chooser::custom_filter_label = "Custom Filter";
const char	*MyFl_File_Chooser::existing_file_label = "Please choose an existing file!";
const char	*MyFl_File_Chooser::favorites_label = "Favorites";
const char	*MyFl_File_Chooser::filename_label = "Filename:";
#ifdef WIN32
const char	*MyFl_File_Chooser::filesystems_label = "My Computer";
#else
const char	*MyFl_File_Chooser::filesystems_label = "File Systems";
#endif // WIN32
const char	*MyFl_File_Chooser::manage_favorites_label = "Manage Favorites";
const char	*MyFl_File_Chooser::new_directory_label = "New Directory?";
const char	*MyFl_File_Chooser::new_directory_tooltip = "Create a new directory.";
const char	*MyFl_File_Chooser::preview_label = "Preview";
const char	*MyFl_File_Chooser::save_label = "Save";
const char	*MyFl_File_Chooser::show_label = "Show:";
Fl_File_Sort_F	*MyFl_File_Chooser::sort = fl_numericsort;
...
void
MyFl_File_Chooser::directory(const char *d)// I - Directory to change to
{
  char	*dirptr;			// Pointer into directory


//  printf("MyFl_File_Chooser::directory(\"%s\")\n", d == NULL ? "(null)" : d);
...
void
MyFl_File_Chooser::favoritesButtonCB()
{
...
//
// 'MyFl_File_Chooser::favoritesCB()' - Handle favorites dialog.
//

void
MyFl_File_Chooser::favoritesCB(Fl_Widget *w)
					// I - Widget
{
  int		i;			// Looping var
...
//
// 'MyFl_File_Chooser::fileListCB()' - Handle clicks (and double-clicks) in the
//                                   Fl_File_Browser.
//

void
MyFl_File_Chooser::fileListCB()
{
...
void
MyFl_File_Chooser::filter(const char *p)		// I - Pattern(s)
{
...
//
// 'MyFl_File_Chooser::preview()' - Enable or disable the preview tile.
//

void
MyFl_File_Chooser::preview(int e)// I - 1 = enable preview, 0 = disable preview
{
...
//
// 'MyFl_File_Chooser::previewCB()' - Timeout handler for the preview box.
//

void
MyFl_File_Chooser::previewCB(MyFl_File_Chooser *fc) {	// I - File chooser
  fc->update_preview();
}
...
void
MyFl_File_Chooser::showChoiceCB()
{
...
//
// 'MyFl_File_Chooser::update_favorites()' - Update the favorites menu.
//

void
MyFl_File_Chooser::update_favorites()
{
  int		i;			// Looping var
  char		pathname[1024],		// Pathname
		menuname[2048];		// Menu name
...
//
// 'MyFl_File_Chooser::update_preview()' - Update the preview box...
//

void
MyFl_File_Chooser::update_preview()
{
...
MyFl_File_Chooser::value(int f)	// I - File number
{
  int		i;		// Looping var
  int		fcount;		// Number of selected files
...
//
// 'MyFl_File_Chooser::value()' - Set the current filename.
//

void
MyFl_File_Chooser::value(const char *filename)
...
//  printf("MyFl_File_Chooser::value(\"%s\")\n", filename == NULL ? "(null)" : filename);
