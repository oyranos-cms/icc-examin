...
inline void ICCfltkBetrachter::cb_Close_i(Fl_Button*, void*) {
  vcgt->hide();
}
void ICCfltkBetrachter::cb_Close(Fl_Button* o, void* v) {
  ((ICCfltkBetrachter*)(o->parent()->parent()->user_data()))->cb_Close_i(o,v);
}

inline void ICCfltkBetrachter::cb_Refresh_i(Fl_Button*, void*) {
  icc_examin->vcgtZeigen();
}
void ICCfltkBetrachter::cb_Refresh(Fl_Button* o, void* v) {
...
Fl_Menu_Item ICCfltkBetrachter::menu_menueleiste[] = {
 {gettext("Files"), 0,  0, 0, 64, 0, 0, 14, 56},
 {gettext("Open"), 0x4006f,  (Fl_Callback*)ICCfltkBetrachter::cb_Open, 0, 0, 0, 0, 14, 56},
 {gettext("Save Report"), 0,  (Fl_Callback*)ICCfltkBetrachter::cb_menueintrag_html_speichern, 0, 129, 0, 0, 14, 56},
 {gettext("Quit"), 0x40071,  (Fl_Callback*)ICCfltkBetrachter::cb_Quit, 0, 0, 0, 0, 14, 56},
 {0},
 {gettext("Edit"), 0,  0, 0, 64, 0, 0, 14, 56},
 {gettext("Oyranos Settings"), 0,  (Fl_Callback*)ICCfltkBetrachter::cb_Oyranos, 0, 0, 0, 0, 14, 56},
 {0},
 {gettext("Gamut"), 0x40068,  (Fl_Callback*)ICCfltkBetrachter::cb_menueintrag_huelle, 0, 2, 0, 0, 14, 56},
 {gettext("View"), 0,  0, 0, 192, 0, 0, 14, 56},
 {gettext("Whole Screen on/off"), 0x40076,  (Fl_Callback*)ICCfltkBetrachter::cb_menueintrag_Voll, 0, 128, 0, 0, 14, 56},
 {gettext("Report View"), 0x40062,  (Fl_Callback*)ICCfltkBetrachter::cb_menueintrag_inspekt, 0, 3, 0, 0, 14, 56},
 {gettext("3D Gamut"), 0x40068,  (Fl_Callback*)ICCfltkBetrachter::cb_menueintrag_3D, 0, 130, 0, 0, 14, 56},
 {gettext("CGATS View"), 0x40067,  (Fl_Callback*)ICCfltkBetrachter::cb_menueintrag_zeigcgats, 0, 1, 0, 0, 14, 56},
 {gettext("Videocard Gamma"), 0x40074,  (Fl_Callback*)ICCfltkBetrachter::cb_menueintrag_vcgt, 0, 0, 0, 0, 14, 56},
 {gettext("Test Curves"), 0x50074,  (Fl_Callback*)ICCfltkBetrachter::cb_menueintrag_testkurven, 0, 0, 0, 0, 14, 56},
 {0},
 {gettext("Help"), 0,  0, 0, 64, 0, 0, 14, 56},
 {gettext("About"), 0xffbe,  (Fl_Callback*)ICCfltkBetrachter::cb_About, 0, 0, 0, 0, 14, 56},
 {0},
 {0}
};
...
Fl_Menu_Item* ICCfltkBetrachter::menueintrag_inspekt = ICCfltkBetrachter::menu_menueleiste + 11;
Fl_Menu_Item* ICCfltkBetrachter::menueintrag_3D = ICCfltkBetrachter::menu_menueleiste + 12;
Fl_Menu_Item* ICCfltkBetrachter::menueintrag_zeigcgats = ICCfltkBetrachter::menu_menueleiste + 13;
Fl_Menu_Item* ICCfltkBetrachter::menueintrag_vcgt = ICCfltkBetrachter::menu_menueleiste + 14;
Fl_Menu_Item* ICCfltkBetrachter::menueintrag_testkurven = ICCfltkBetrachter::menu_menueleiste + 15;
Fl_Menu_Item* ICCfltkBetrachter::menu_hilfe = ICCfltkBetrachter::menu_menueleiste + 17;
...
/*    Flu_File_Chooser:: = _("");
  ...
  #endif
  { Fl_Double_Window* o = ueber = new Fl_Double_Window(366, 241, gettext("About ICC Examin"));
    w = o;
    ...
    { Fl_Group* o = new Fl_Group(0, 0, 365, 240);
      ...
      { Fl_Button* o = ja = new Fl_Button(130, 210, 110, 25, gettext("Yes"));
  ...
  { Fl_Double_Window* o = vcgt = new Fl_Double_Window(370, 390, gettext("Grafic Card Gamma Table"));
    w = o;
    o->user_data((void*)(this));
    { Fl_Group* o = new Fl_Group(0, 0, 370, 390);
      ...
      { Fl_Button* o = new Fl_Button(290, 360, 75, 25, gettext("Close"));
        o->callback((Fl_Callback*)cb_Close);
      }
      { Fl_Button* o = new Fl_Button(195, 360, 95, 25, gettext("Refresh"));
        o->tooltip(gettext("refresh gamma table from video card"));
        o->callback((Fl_Callback*)cb_Refresh);
        w->hotspot(o);
      }
      { Fl_Button* o = new Fl_Button(80, 360, 115, 25, gettext("Monitorprofile"));
        o->tooltip(gettext("Set the current profile as monitor profile and upload vcgt tag to the video c\
ard"));
        o->callback((Fl_Callback*)cb_Monitorprofile);
        w->hotspot(o);
      }
      { Fl_Button* o = new Fl_Button(5, 360, 75, 25, gettext("Standard"));
        o->tooltip(gettext("reset to standard gamma"));
  ...
  { Fl_Double_Window* o = details = new Fl_Double_Window(385, 520, gettext("ICC Details"));
    w = o;
    o->box(FL_NO_BOX);
    o->color((Fl_Color)53);
    o->user_data((void*)(this));
    { Fl_Group* o = new Fl_Group(0, 0, 385, 520);
      { Fl_Menu_Bar* o = menueleiste = new Fl_Menu_Bar(0, 0, 385, 25);
        ...
        o->when(3);
        { Fl_Menu_Item* o = &menu_menueleiste[14];
          o->hide();
        }
      ...
      { Fl_Help_View* o = inspekt_html = new Fl_Help_View(0, 25, 385, 470, gettext("Inspect"));
        o->align(FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
        o->hide();
      }
      { Fl_Tile* o = examin = new Fl_Tile(0, 25, 385, 470);
        { TagBrowser* o = tag_browser = new TagBrowser(0, 25, 385, 135, gettext("Tags"));
          o->tooltip(gettext("Choose one profile tag"));
          o->box(FL_NO_BOX);
          o->color(FL_BACKGROUND_COLOR);
        ...
        { Fl_Group* o = ansichtsgruppe = new Fl_Group(0, 160, 385, 335);
          { Fl_Group* o = tabellengruppe = new Fl_Group(0, 160, 385, 335);
            { MftChoice* o = mft_choice = new MftChoice(0, 160, 385, 25, gettext("Chain selection"));
              o->tooltip(gettext("Choose a attribute"));
              o->box(FL_NO_BOX);
            ...
            { TagTexts* o = mft_text = new TagTexts(0, 185, 385, 310, gettext("Chain -texts"));
              o->box(FL_NO_BOX);
              o->color((Fl_Color)48);
              o->selection_color(FL_SELECTION_COLOR);
              o->labeltype(FL_NORMAL_LABEL);
          ...
          { TagTexts* o = tag_text = new TagTexts(0, 160, 385, 335, gettext("Texts"));
            o->box(FL_NO_BOX);
            o->color(FL_BACKGROUND_COLOR);
            o->selection_color(FL_SELECTION_COLOR);
            o->labeltype(FL_NORMAL_LABEL);
      ...
      { Fl_Group* o = new Fl_Group(0, 495, 385, 25);
        ...
        { Fl_Progress* o = load_progress = new Fl_Progress(0, 495, 385, 25, gettext("Loading .."));
          o->hide();
          o->maximum(1.0);
          o->minimum(0.0);
        }
  ...
  const Fl_Menu_Item* mi = menue_uebersetzen( dynamic_cast<Fl_Menu_*>(menueleiste) );
  menueleiste->copy( mi );
  DBG_PROG_ENDE
  return w;
}
