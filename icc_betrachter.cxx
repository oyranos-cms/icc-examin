          ...
          { ansichtsgruppe = new Fl_Group(0, 160, 385, 335);
            ...
            { Fl_Group* o = tabellengruppe = new Fl_Group(0, 160, 385, 335);
              ...
              { Fl_Pack* o = new Fl_Pack(0, 160, 385, 335);
                ...
                mft_choice->color(FL_BACKGROUND_COLOR);
                mft_choice->selection_color(FL_SELECTION_COLOR);
                mft_choice->labeltype(FL_NORMAL_LABEL);
                mft_choice->labelfont(0);
                mft_choice->labelsize(14);
                mft_choice->labelcolor(FL_FOREGROUND_COLOR);
                mft_choice->callback((Fl_Callback*)cb_mft_choice);
                mft_choice->align(Fl_Align(FL_ALIGN_LEFT));
                ...
                mft_viewer->labelcolor(FL_FOREGROUND_COLOR);
                mft_viewer->align(Fl_Align(FL_ALIGN_LEFT));
                ...
                mft_text->align(Fl_Align(FL_ALIGN_LEFT));
                mft_text->when(FL_WHEN_RELEASE_ALWAYS);
                o->show();
                } // TagTexts* mft_text
                { mft_gl_group = new Fl_Group(0, 185, 385, 310);
                mft_gl_group->align(Fl_Align(FL_ALIGN_LEFT));
                ...
                mft_gl->labelfont(0);
                mft_gl->labelsize(14);
                mft_gl->labelcolor(FL_FOREGROUND_COLOR);
                mft_gl->align(Fl_Align(FL_ALIGN_LEFT));
