...
icc_examin_ns::MyFl_Double_Window* ICCfltkBetrachter::init(int argc, char** argv) {
  ...
  { icc_examin_ns::MyFl_Double_Window* o = ueber = new icc_examin_ns::MyFl_Double_Window(365, 295, _("About ICC Examin"));
    ...
    { Fl_Group* o = new Fl_Group(0, 0, 375, 295);
      { Fl_Tabs* o = new Fl_Tabs(0, 0, 365, 260);
        ...
        { Fl_Help_View* o = lizenz_html = new Fl_Help_View(0, 25, 365, 235, _("License"));
          o->box(FL_THIN_UP_BOX);
          o->color(FL_BACKGROUND_COLOR);
          o->selection_color(FL_DARK1);
          o->hide();
        ...
        { Fl_Help_View* o = dank_html = new Fl_Help_View(0, 25, 365, 235, _("Acknowlegement"));
          o->box(FL_THIN_UP_BOX);
          o->color(FL_BACKGROUND_COLOR);
          o->selection_color(FL_DARK1);
          o->hide();
      ...
      { Fl_Button* o = ja = new Fl_Button(130, 264, 110, 25, _("Yes"));
  ...
  { icc_examin_ns::MyFl_Double_Window* o = vcgt = new icc_examin_ns::MyFl_Double_Window(370, 405, _("Grafic Card Gamma Table"));
    ...
    { Fl_Group* o = new Fl_Group(0, 0, 370, 395);
      ...
      { Fl_Button* o = vcgt_set_button = new Fl_Button(10, 370, 85, 25, _("Set"));
...
ard"));
      ...
      { Fl_Button* o = vcgt_reset_button = new Fl_Button(95, 370, 90, 25, _("Reset"));
        o->tooltip(_("reset to standard gamma"));
        o->callback((Fl_Callback*)cb_vcgt_reset_button);
        w->hotspot(o);
      }
      { Fl_Button* o = vcgt_load_button = new Fl_Button(185, 370, 90, 25, _("Load"));
        o->tooltip(_("Load the current monitor profile"));
        o->callback((Fl_Callback*)cb_vcgt_load_button);
        w->hotspot(o);
      }
      { Fl_Button* o = vcgt_close_button = new Fl_Button(275, 370, 90, 25, _("Close"));
  ...
  { icc_examin_ns::MyFl_Double_Window* o = details = new icc_examin_ns::MyFl_Double_Window(385, 520, _("ICC Examin"));
    ...
    { Fl_Group* o = new Fl_Group(0, 0, 385, 520, _("all_invisible"));
      { Fl_Menu_Bar* o = menueleiste = new Fl_Menu_Bar(0, 0, 385, 25, _("menuleiste_invisible"));
      ...
      { Fl_Group* o = new Fl_Group(0, 25, 385, 470, _("tags_group_invisible"));
        ...
        { Fl_Tile* o = examin = new Fl_Tile(0, 25, 385, 470, _("examin_invisible"));
          o->align(FL_ALIGN_LEFT);
          ...
          { Fl_Group* o = ansichtsgruppe = new Fl_Group(0, 160, 385, 335, _("ansichtsgruppe_invisible"));
            o->align(FL_ALIGN_LEFT);
            { Fl_Group* o = tabellengruppe = new Fl_Group(0, 160, 385, 335, _("tabellengruppe_invisible"));
              ...
              { Fl_Pack* o = new Fl_Pack(0, 160, 385, 335, _("tabellenpack_invisible"));
                ...
                o->labelsize(14);
                o->labelcolor(FL_FOREGROUND_COLOR);
                o->callback((Fl_Callback*)cb_mft_text);
                o->align(FL_ALIGN_LEFT);
                o->when(FL_WHEN_RELEASE_ALWAYS);
                o->show();
                }
                { Fl_Group* o = mft_gl_group = new Fl_Group(0, 185, 385, 310, _("mft_gl_group_invisible"));
                o->align(FL_ALIGN_LEFT);
                ...
                { Fl_Pack* o = mft_gl_button_pack = new Fl_Pack(360, 185, 25, 310);
                ...
                o->callback((Fl_Callback*)cb_mft_gl_alltables_button);
                o->show();
                }
                o->end();
                }
            ...
            { Fl_Pack* o = twoD_pack = new Fl_Pack(0, 160, 385, 335, _("tag_pack_invisible"));
              o->align(FL_ALIGN_LEFT);
              ...
              { Fl_Group* o = new Fl_Group(0, 165, 385, 330, _("tag_group_invisible"));
                ...
                o->labelsize(14);
                o->labelcolor(FL_FOREGROUND_COLOR);
                o->callback((Fl_Callback*)cb_tag_text);
                o->align(FL_ALIGN_LEFT);
                o->when(FL_WHEN_RELEASE_ALWAYS);
                o->show();
                }
      ...
      { Fl_Group* o = new Fl_Group(0, 495, 385, 25, _("status_group_invisible"));
        o->align(FL_ALIGN_LEFT);
        { Fl_Box* o = box_stat = new Fl_Box(0, 495, 385, 25, _("..."));
          o->align(FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
        }
