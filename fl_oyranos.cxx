...
Fl_Double_Window* voreinstellungen_intern() {
  Fl_Double_Window* w;
  { Fl_Double_Window* o = new Fl_Double_Window(375, 205, gettext("Preferences"));
    w = o;
    { Fl_Tabs* o = new Fl_Tabs(0, 0, 375, 205, gettext("Preferences"));
      o->align(FL_ALIGN_TOP|FL_ALIGN_INSIDE);
      { Fl_Group* o = new Fl_Group(0, 25, 375, 180, gettext("ICC Profiles"));
        { Fl_Group* o = order_gruppe = new Fl_Group(5, 30, 365, 115);
          o->box(FL_ENGRAVED_FRAME);
          { Fl_Button* o = new Fl_Button(80, 105, 75, 30, gettext("Erase"));
            o->callback((Fl_Callback*)cb_Erase);
          }
          { Fl_Button* o = new Fl_Button(160, 105, 85, 30, gettext("Refresh"));
            o->callback((Fl_Callback*)cb_Refresh);
          }
          { Fl_Button* o = new Fl_Button(280, 105, 85, 30, gettext("New"));
            o->callback((Fl_Callback*)cb_New);
          }
          { TagTexts* o = fl_oyanos_pfade_browser = new TagTexts(80, 35, 285, 70, gettext("Paths:"));
            o->box(FL_NO_BOX);
